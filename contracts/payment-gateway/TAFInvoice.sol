...
contract TAFInvoice{
    ...
    function withdrawToken(address reciver) public{
        require(reciver == owner, "Only Owner Can Withdraw Tokens");
        tafToken.transfer(reciver, invoiceBalance());
    }
    ...
    function invoiceBalance() public view virtual returns (uint256) {
