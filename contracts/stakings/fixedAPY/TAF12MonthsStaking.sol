...
contract TAF7DaysStaking {
    ...
    modifier onlyAfter12Months {
      require(BokkyPooBahsDateTimeLibrary.diffDays(timestamp[msg.sender], block.timestamp ) >= 372);
      _;
   }
    ...
    function timings() public view returns (uint256, uint256){
        return (timestamp[msg.sender], timestamp[msg.sender] + 372 days);
    }
}