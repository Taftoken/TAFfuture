...
contract TAF7DaysStaking {
    ...
    modifier onlyAfter24Months {
      require(BokkyPooBahsDateTimeLibrary.diffDays(timestamp[msg.sender], block.timestamp ) >= 737);
      _;
   }
    ...
    function timings() public view returns (uint256, uint256){
        return (timestamp[msg.sender], timestamp[msg.sender] + 737 days);
    }
}